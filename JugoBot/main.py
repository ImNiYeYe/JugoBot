...
client = commands.Bot(command_prefix = get_prefix) #command prefix
...
@client.event
async def on_ready():
    await client.change_presence(status=discord.Status.idle, activity=discord.Game('Ping me for server prefix'))#change status
    print('====================================')
    print('Bot is online!')
